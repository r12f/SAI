...
typedef enum _sai_eni_attr_t
{
    ...
    /**
     * @brief Action parameter routing group id
     *
     * @type sai_object_id_t
     * @flags CREATE_AND_SET
...
typedef enum _sai_eni_stat_t
{
    ...
    /** DASH ENI OUTBOUND_ROUTING_GROUP_ADMIN_DOWN_DROP_PACKETS stat count */
    SAI_ENI_STAT_OUTBOUND_ROUTING_GROUP_ADMIN_DOWN_DROP_PACKETS,
