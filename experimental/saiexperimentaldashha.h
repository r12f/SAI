...
typedef enum _sai_ha_set_attr_t
{
    ...
    /**
     * @brief Action set_ha_set_attr parameter DP_CHANNEL_SRC_PORT_MIN
     *
     * @type sai_uint16_t
     * @flags CREATE_AND_SET
     * @isvlan false
     * @default 0
     */
    SAI_HA_SET_ATTR_DP_CHANNEL_SRC_PORT_MIN,

    /**
     * @brief Action set_ha_set_attr parameter DP_CHANNEL_SRC_PORT_MAX
     *
     * @type sai_uint16_t
     * @flags CREATE_AND_SET
     * @isvlan false
     * @default 0
     */
    SAI_HA_SET_ATTR_DP_CHANNEL_SRC_PORT_MAX,
...
typedef enum _sai_ha_scope_attr_t
{
    ...
    /**
     * @brief Action set_ha_scope_attr parameter HA_ROLE
     *
     * @type sai_dash_ha_role_t
     * @flags CREATE_AND_SET
     * @default SAI_DASH_HA_ROLE_DEAD
     */
    SAI_HA_SCOPE_ATTR_HA_ROLE,
